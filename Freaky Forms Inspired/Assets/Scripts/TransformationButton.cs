...
public class TransformationButton : MonoBehaviour, IPointerUpHandler, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    [SerializeField]
    public bool clone, flip, stretchX, squashX, stretchY, squashY, expand, shrink, rotateCW, rotateCCW, layerUp, layerDown, cycleLeft, cycleRight;
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        for (int currBody = 0; currBody < selectedBodies.Length; currBody++)
        {
            if (selectedBodies[currBody] != null)
            {
                selectedBodies[currBody].transform.parent.parent.GetChild(1).rotation = selectedBodies[currBody].transform.parent.rotation;
                selectedBodies[currBody].transform.parent.parent.GetChild(1).localScale = selectedBodies[currBody].transform.parent.localScale;
